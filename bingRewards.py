...
# check if we earned any points
    ...
    def __processSearch(self, reward, verbose, searchType):
...
# so divide it by points per search (rewardsCount) to get correct search count needed
        ...
        if reward.tp == bfp.Reward.Type.SEARCH_PC or reward.tp == bfp.Reward.Type.SEARCH_AND_EARN or searchType == 0:
	...
	searchesCount = 30
        ...
        print
        else: reward.tp == bfp.Reward.Type.SEARCH_MOBILE or searchType == 1:
...
# check for the successfull marker
    ...
    def process(self, rewards, verbose):
        ...
        for r in rewards:
            ...
            elif action == bfp.Reward.Type.Action.SEARCH or searchComplete < 2:
                res = self.__processSearch(r, verbose, searchComplete)
                searchComplete += 1 
            else:
